...
const CAREFUL_SCRIPT = path.join(ROOT, 'runtimes', 'hooks', 'careful', 'bin', 'check-careful.sh');
const FREEZE_SCRIPT = path.join(ROOT, 'runtimes', 'hooks', 'freeze', 'bin', 'check-freeze.sh');
