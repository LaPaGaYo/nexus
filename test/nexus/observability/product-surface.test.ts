...
} from '../../../lib/nexus/observability/product-surface';
import {
...
describe('nexus product surface contract', () => {
  ...
  test('readme and skills docs describe a Nexus-only active surface', () => {
    ...
    // The Model 纬 invariant (Nexus is the only command surface) is preserved
    ...
    // independently. The Model 纬 invariant (Nexus owns the runtime units) is
