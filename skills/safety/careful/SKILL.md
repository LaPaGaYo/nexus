...
1. Confirm `/careful` is active for the current session.
2. Continue normal work.
3. When a destructive Bash command is detected, stop and show the warning.
4. Run the command only if the user explicitly chooses to proceed.
5. If the command is not needed, choose a safer alternative and explain it.
