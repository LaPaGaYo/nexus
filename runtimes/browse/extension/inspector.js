/**
 * nexus browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__nexusInspectorActive) return;
  window.__nexusInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'nexus-inspector-highlight';
    ...
    tooltipEl.id = 'nexus-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'nexus-inspector-highlight' || target.id === 'nexus-inspector-tooltip') return;
