...
export const REPO_TAXONOMY_FACADES: RepoTaxonomyFacade[] = [
  ...
  },
  {
    ...
    category: 'hosts',
    kind: 'navigation_only',
    active_source_paths: ['CLAUDE.md', 'hosts/claude/rules', 'hosts/codex/openai.yaml', '.claude/rules', '.agents', '.gemini', '.factory'],
  ...
  },
  {
    ...
    category: 'hosts',
    kind: 'navigation_only',
    active_source_paths: ['hosts/codex/openai.yaml', 'agents/openai.yaml', '.agents'],
