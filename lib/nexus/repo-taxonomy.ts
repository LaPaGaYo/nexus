...
export const REPO_TAXONOMY_ENTRIES: RepoTaxonomyEntry[] = [
  ...
  },
  {
    name: 'careful',
    category: 'runtimes',
    current_path: 'runtimes/safety/careful',
    target_path: 'runtimes/safety/careful',
    move_policy: 'keep_in_place',
    risk_level: 'medium',
    rationale: 'Careful hook helper binaries have moved under runtimes/safety while installed safety skills keep $NEXUS_ROOT/careful/bin as a compatibility path.',
    runtime_compat_paths: ['$NEXUS_ROOT/careful/bin/check-careful.sh'],
  },
  {
    name: 'freeze',
    category: 'runtimes',
    current_path: 'runtimes/safety/freeze',
    target_path: 'runtimes/safety/freeze',
    move_policy: 'keep_in_place',
    risk_level: 'medium',
    rationale: 'Freeze hook helper binaries have moved under runtimes/safety while installed safety skills keep $NEXUS_ROOT/freeze/bin as a compatibility path.',
...
export const REPO_TAXONOMY_FACADES: RepoTaxonomyFacade[] = [
  {
    ...
    category: 'runtimes',
    kind: 'navigation_only',
    active_source_paths: ['runtimes/browse', 'runtimes/design', 'runtimes/design-html', 'runtimes/safety/careful', 'runtimes/safety/freeze'],
  ...
  },
  {
    ...
    category: 'runtimes',
    kind: 'navigation_only',
    active_source_paths: ['runtimes/safety/careful', 'runtimes/safety/freeze'],
    note: 'Safety runtime facade. Hook helper binaries now live under runtimes/safety while installed $NEXUS_ROOT/careful and $NEXUS_ROOT/freeze paths remain compatibility links.',
  },
  {
  ...
  },
  {
    ...
    category: 'hosts',
    kind: 'navigation_only',
    active_source_paths: ['CLAUDE.md', 'hosts/claude/rules', 'hosts/codex/openai.yaml', '.claude/rules', 'agents/openai.yaml', 'hosts/gemini-cli', 'hosts/factory'],
    note: 'Host facade root. Tracked host sources live under hosts/ while generated output and discovery compatibility paths remain readable.',
  },
  {
  ...
  },
  {
    ...
    category: 'hosts',
    kind: 'navigation_only',
    active_source_paths: ['hosts/gemini-cli'],
    note: 'Gemini CLI host facade. Generated .gemini output remains a compatibility surface.',
  },
  {
    facade_path: 'hosts/factory/README.md',
    category: 'hosts',
    kind: 'navigation_only',
    active_source_paths: ['hosts/factory'],
    note: 'Factory host facade. Generated .factory output remains a compatibility surface.',
  },
  {
