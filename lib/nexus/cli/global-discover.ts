#!/usr/bin/env bun
/**
 * nexus-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   nexus-global-discover --since 7d [--format json|summary]
 *   nexus-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: nexus-global-discover --since <window> [--format json|summary]
...
Examples:
  nexus-global-discover --since 7d
  nexus-global-discover --since 14d --format summary`);
}
