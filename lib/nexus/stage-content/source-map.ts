...
const REVIEW_SOURCE_REFS: AbsorbedSourceRef[] = [
  {
    ...
    upstream_file: 'vendor/upstream/superpowers/skills/requesting-code-review/SKILL.md',
  ...
  },
  {
    ...
    upstream_file: 'vendor/upstream/gsd/sdk/prompts/workflows/verify-phase.md',
    canonical_stage: 'review',
