...
export const REPO_TAXONOMY_ENTRIES: RepoTaxonomyEntry[] = [
  ...
  },
  {
    ...
    move_policy: 'keep_in_place',
    risk_level: 'low',
    rationale: 'The runtime core is intentionally namespaced under lib/nexus and is now organized by concern subdirectories.',
  },
  {
    name: 'lib',
    category: 'lib',
    ...
    move_policy: 'keep_in_place',
    risk_level: 'low',
    rationale: 'The top-level lib directory remains a deliberate namespace root even while lib/nexus is its only child.',
  },
  {
    name: 'claude-host',
    category: 'hosts',
  ...
  },
  {
    ...
    move_policy: 'keep_in_place',
    risk_level: 'low',
    rationale: 'Executable shims and built binaries remain in bin while TypeScript CLI sources live under lib/nexus/cli.',
  },
  {
    name: 'scripts',
    category: 'scripts',
