...
export const CANONICAL_MANIFEST: Record<CanonicalCommandId, CommandContract> = {
  ...
  build: {
    ...
    optional_outputs: [stageCompletionAdvisorPath('build')],
  ...
  review: {
    ...
    optional_outputs: [stageCompletionAdvisorPath('review')],
  ...
  ship: {
    ...
    optional_outputs: [stageCompletionAdvisorPath('ship')],
  ...
  closeout: {
    ...
    optional_outputs: [stageCompletionAdvisorPath('closeout')],
