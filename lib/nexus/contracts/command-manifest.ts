...
export const CANONICAL_MANIFEST: Record<CanonicalCommandId, CommandContract> = {
  ...
  frame: {
    ...
    optional_outputs: [stageCompletionAdvisorPath('frame')],
  ...
  plan: {
    ...
    optional_outputs: [planDesignContractPath(), stageCompletionAdvisorPath('plan')],
  ...
  handoff: {
    ...
    optional_outputs: [stageCompletionAdvisorPath('handoff')],
  ...
  ship: {
    ...
    optional_outputs: [stageVerificationEvidencePath('ship'), stageCompletionAdvisorPath('ship')],
  ...
  closeout: {
    ...
    optional_outputs: [stageVerificationEvidencePath('closeout'), stageCompletionAdvisorPath('closeout')],
